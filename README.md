...
2. How does it work
    ...
    5. Apply IOC rules from ioc.csv (allow/deny override the score)
    6. Print valid IPs: address, score, country name, ioc description (if in ioc.csv), rule (if in ioc.csv)
